...
namespace SystemSetteiHoshu.Logic
{
    ...
    public class SystemSetteiHoshuLogic : IBuisinessLogic
    {
        ...
        /// <summary>
        /// システム設定のDao
        /// lớp Dao trong cài đặt hệ thống
        /// </summary>
        ...
        public bool CreateEntity(bool isDelete)
        {
            try
            {
                ...
                //quoc-begin
                //見積2
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU1.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU1 = this.form.MOD_SOUSHIN_HYOU_BIKOU1.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU2.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU2 = this.form.MOD_SOUSHIN_HYOU_BIKOU2.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU3.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU3 = this.form.MOD_SOUSHIN_HYOU_BIKOU3.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU4.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU4 = this.form.MOD_SOUSHIN_HYOU_BIKOU4.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU5.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU5 = this.form.MOD_SOUSHIN_HYOU_BIKOU5.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU6.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU6 = this.form.MOD_SOUSHIN_HYOU_BIKOU6.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU7.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU7 = this.form.MOD_SOUSHIN_HYOU_BIKOU7.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU8.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU8 = this.form.MOD_SOUSHIN_HYOU_BIKOU8.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU9.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU9 = this.form.MOD_SOUSHIN_HYOU_BIKOU9.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU10.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU10 = this.form.MOD_SOUSHIN_HYOU_BIKOU10.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU11.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU11 = this.form.MOD_SOUSHIN_HYOU_BIKOU11.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU12.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU12 = this.form.MOD_SOUSHIN_HYOU_BIKOU12.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU13.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU13 = this.form.MOD_SOUSHIN_HYOU_BIKOU13.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU14.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU14 = this.form.MOD_SOUSHIN_HYOU_BIKOU14.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU15.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU15 = this.form.MOD_SOUSHIN_HYOU_BIKOU15.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU16.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU16 = this.form.MOD_SOUSHIN_HYOU_BIKOU16.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU17.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU17 = this.form.MOD_SOUSHIN_HYOU_BIKOU17.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU18.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU18 = this.form.MOD_SOUSHIN_HYOU_BIKOU18.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU19.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU19 = this.form.MOD_SOUSHIN_HYOU_BIKOU19.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU20.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU20 = this.form.MOD_SOUSHIN_HYOU_BIKOU20.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU21.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU21 = this.form.MOD_SOUSHIN_HYOU_BIKOU21.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU22.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU22 = this.form.MOD_SOUSHIN_HYOU_BIKOU22.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU23.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU23 = this.form.MOD_SOUSHIN_HYOU_BIKOU23.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU24.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU24 = this.form.MOD_SOUSHIN_HYOU_BIKOU24.Text;
                }
                if (this.form.MOD_SOUSHIN_HYOU_BIKOU25.Text.Length > 0)
                {
                    this.insEntitys.MOD_SOUSHIN_HYOU_BIKOU25 = this.form.MOD_SOUSHIN_HYOU_BIKOU25.Text;
                }
        ...
        public virtual void Regist(bool errorFlag)
        {
            ...
            {
                //エラーではない場合登録処理を行う
                //Nếu không phải lỗi thì thực hiện xử lý đăng ký
                if (!errorFlag)
                {
        ...
        internal bool SetIchiran()
        {
            try
            {
                ...
                //quoc-begin
                this.form.MOD_SOUSHIN_HYOU_BIKOU1.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU1"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU2.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU2"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU3.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU3"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU4.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU4"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU5.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU5"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU6.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU6"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU7.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU7"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU8.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU8"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU9.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU9"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU10.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU10"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU11.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU11"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU12.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU12"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU13.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU13"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU14.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU14"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU15.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU15"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU16.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU16"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU17.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU17"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU18.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU18"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU19.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU19"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU20.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU20"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU21.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU21"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU22.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU22"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU23.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU23"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU24.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU24"].ToString();
                this.form.MOD_SOUSHIN_HYOU_BIKOU25.Text = this.SearchResult.Rows[0]["MOD_SOUSHIN_HYOU_BIKOU25"].ToString();
                //quoc-end
                //CongBinh 20210712 #152799 S
        ...
        /// <summary>
        /// 見積税区分の制限処理
        /// Các hạn chế về loại thuế ước tính
        /// </summary>
