...
namespace TorihikisakiHoshu.Logic
{
    ...
    /// 事業者入力のビジネスロジック
    /// </summary>
    public class TorihikisakiHoshuLogic : IBuisinessLogic
    {
        #region フィールド
        ...
        /// <summary>
        /// 画面項目初期化【新規】モード
        /// Chế độ khởi tạo mục màn hình [mới]
        /// </summary>
        /// <param name="parentForm">親フォーム</param>
        public bool WindowInitNewMode(BusinessBaseForm parentForm)
        {
            try
            {
                ...
                //quoc-begin
                this.form.MOD_KAKUIN_O_INJI.Text = "2";
                //quoc-end
        ...
        public bool ChangeTorihikiKbn(bool isTextChanged)
        {
            try
            {
                ...
                if (this.form.TORIHIKI_KBN.Text.Equals("1"))
                {
                    ...
                    //quoc-begin
                    this.form.MOD_GYOU_INJI_KUBUN.Enabled = false;
                    this.form.MOD_KAKUIN_O_INJI.Text = string.Empty;
                    this.form.MOD_KAKUIN_O_INJI.Enabled = false;
                    //quoc-end
                }
                else
                {
                    this.form.MOD_KAKUIN_O_INJI.Enabled = true;
                    this.form.MOD_KAKUIN_O_INJI.Text = "1";
                    //quoc-begin
        ...
        //quoc-begin
        public bool CheckRegistKakuin()
        {
            try
            {
                MessageBoxShowLogic msgLogic = new MessageBoxShowLogic();

                if (string.IsNullOrEmpty(this.form.MOD_KAKUIN_O_INJI.Text))
                {
                    var result = msgLogic.MessageBoxShow("E001", "角印を印字");
                    this.form.MOD_KAKUIN_O_INJI.BackColor = Constans.ERROR_COLOR;
                    return true;
                }
                return false;
            }
            ...
            {
                LogUtility.Error("CheckRegistKakuin", ex);
                this.form.errmessage.MessageBoxShow("E245", "");
                return true;
            }
