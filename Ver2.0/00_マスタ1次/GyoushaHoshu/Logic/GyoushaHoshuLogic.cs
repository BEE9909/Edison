    ...
    public class GyoushaHoshuLogic : IBuisinessLogic
    {
        ...
        public bool WindowInit(WINDOW_TYPE windowType)
        {
            try
            {
                ...
                // 処理モード別画面初期化
                //Khởi tạo màn hình bằng chế độ xử lý
        ...
        public bool WindowInitReference(BusinessBaseForm parentForm)
        {
            ...
            {
                // 検索結果を画面に設定
                //Đặt kết quả tìm kiếm thành màn hình
                this.SetWindowData();
        ...
        /// <summary>
        /// データを取得し、画面に設定
        /// Nhận dữ liệu và đặt trên màn hình
        /// </summary>
        private void SetWindowData()
        {
            ...
            //quoc-begin
            this.form.MOD_URIAGE_GURUUPU_CD.Text = this.GyoushaEntity.MOD_URIAGE_GURUUPU_CD;
            this.form.MOD_URIAGE_GURUUPU_NAME.Text = this.GyoushaEntity.MOD_URIAGE_GURUUPU_NAME;
            this.form.MOD_SHIHARAI_GURUUPU_CD.Text = this.GyoushaEntity.MOD_SHIHARAI_GURUUPU_CD;
            this.form.MOD_SHIHARAI_GURUUPU_NAME.Text = this.GyoushaEntity.MOD_SHIHARAI_GURUUPU_NAME;
            //quoc-end
        ...
        private void AllControlLock(bool isBool)
        {
            ...
            //quoc-begin
            this.form.MOD_URIAGE_GURUUPU_CD.Enabled = isBool;
            this.form.MOD_SHIHARAI_GURUUPU_CD.Enabled = isBool;
            this.form.MOD_GYOUSHA_URIAGE_SEARCH_BUTTON.Enabled = isBool;
            this.form.MOD_GYOUSHA_SHIHARAI_SEARCH_BUTTON.Enabled = isBool;
            //quoc-end
        }
        ...
        public GyoushaHoshuConstans.GyoushaCdLeaveResult DupliCheckGyoushaCd(string zeroPadCd, bool isRegister)
        {
            ...
            // 業者マスタ検索
            //Tìm kiếm chính của nhà cung cấp
        ...
        public bool CreateGyoushaEntity(bool isDelete)
        {
            try
            {
                ...
                //quoc-begin
                this.GyoushaEntity.MOD_URIAGE_GURUUPU_CD = this.form.MOD_URIAGE_GURUUPU_CD.Text;
                this.GyoushaEntity.MOD_URIAGE_GURUUPU_NAME = this.form.MOD_URIAGE_GURUUPU_NAME.Text;
                this.GyoushaEntity.MOD_SHIHARAI_GURUUPU_CD = this.form.MOD_SHIHARAI_GURUUPU_CD.Text;
                this.GyoushaEntity.MOD_SHIHARAI_GURUUPU_NAME = this.form.MOD_SHIHARAI_GURUUPU_NAME.Text;
                //quoc-end
                ...
                // 更新者情報設定
                //Cài đặt thông tin trình cập nhật
        ...
        //quoc-begin
        internal bool CreateGenbaEntity1()
        {
            try
            {
                LogUtility.DebugMethodStart();
                ...
                if (this.IsGenbaAdd)
                {
                    this.genbaEntity1 = new M_GENBA();
                }

                this.genbaEntity1.GYOUSHA_CD = this.GyoushaEntity.GYOUSHA_CD;
                this.genbaEntity1.GENBA_CD = "999999";
                this.genbaEntity1.TORIHIKISAKI_CD = this.GyoushaEntity.TORIHIKISAKI_CD;
                this.genbaEntity1.KYOTEN_CD = this.GyoushaEntity.KYOTEN_CD;
                this.genbaEntity1.GENBA_NAME1 = "諸口現場";
                this.genbaEntity1.GENBA_NAME2 = "";
                this.genbaEntity1.GENBA_NAME_RYAKU = "諸口現場";
                this.genbaEntity1.GENBA_FURIGANA = "ショクチゲンバ";
                this.genbaEntity1.GENBA_TEL = this.GyoushaEntity.GYOUSHA_TEL;
                this.genbaEntity1.GENBA_FAX = this.GyoushaEntity.GYOUSHA_FAX;
                this.genbaEntity1.GENBA_KEITAI_TEL = this.GyoushaEntity.GYOUSHA_KEITAI_TEL;
                this.genbaEntity1.GENBA_KEISHOU1 = this.GyoushaEntity.GYOUSHA_KEISHOU1;
                this.genbaEntity1.GENBA_KEISHOU2 = this.GyoushaEntity.GYOUSHA_KEISHOU2;
                this.genbaEntity1.EIGYOU_TANTOU_BUSHO_CD = this.GyoushaEntity.EIGYOU_TANTOU_BUSHO_CD;
                this.genbaEntity1.EIGYOU_TANTOU_CD = this.GyoushaEntity.EIGYOU_TANTOU_CD;
                this.genbaEntity1.GENBA_POST = this.GyoushaEntity.GYOUSHA_POST;
                this.genbaEntity1.GENBA_TODOUFUKEN_CD = this.GyoushaEntity.GYOUSHA_TODOUFUKEN_CD;
                this.genbaEntity1.GENBA_ADDRESS1 = this.GyoushaEntity.GYOUSHA_ADDRESS1;
                this.genbaEntity1.GENBA_ADDRESS2 = this.GyoushaEntity.GYOUSHA_ADDRESS2;
                this.genbaEntity1.TORIHIKI_JOUKYOU = this.GyoushaEntity.TORIHIKI_JOUKYOU;
                this.genbaEntity1.CHUUSHI_RIYUU1 = this.GyoushaEntity.CHUUSHI_RIYUU1;
                this.genbaEntity1.CHUUSHI_RIYUU2 = this.GyoushaEntity.CHUUSHI_RIYUU2;
                this.genbaEntity1.BUSHO = this.GyoushaEntity.BUSHO;
                this.genbaEntity1.TANTOUSHA = this.GyoushaEntity.TANTOUSHA;
                this.genbaEntity1.SHUUKEI_ITEM_CD = this.GyoushaEntity.SHUUKEI_ITEM_CD;
                this.genbaEntity1.GYOUSHU_CD = this.GyoushaEntity.GYOUSHU_CD;
                this.genbaEntity1.CHIIKI_CD = this.GyoushaEntity.CHIIKI_CD;
                this.genbaEntity1.BIKOU1 = this.GyoushaEntity.BIKOU1;
                this.genbaEntity1.BIKOU2 = this.GyoushaEntity.BIKOU2;
                this.genbaEntity1.BIKOU3 = this.GyoushaEntity.BIKOU3;
                this.genbaEntity1.BIKOU4 = this.GyoushaEntity.BIKOU4;
                this.genbaEntity1.SEIKYUU_SOUFU_NAME1 = this.GyoushaEntity.SEIKYUU_SOUFU_NAME1;
                this.genbaEntity1.SEIKYUU_SOUFU_NAME2 = this.GyoushaEntity.SEIKYUU_SOUFU_NAME2;
                this.genbaEntity1.SEIKYUU_SOUFU_KEISHOU1 = this.GyoushaEntity.SEIKYUU_SOUFU_KEISHOU1;
                this.genbaEntity1.SEIKYUU_SOUFU_KEISHOU2 = this.GyoushaEntity.SEIKYUU_SOUFU_KEISHOU2;
                this.genbaEntity1.SEIKYUU_SOUFU_POST = this.GyoushaEntity.SEIKYUU_SOUFU_POST;
                this.genbaEntity1.SEIKYUU_SOUFU_ADDRESS1 = this.GyoushaEntity.SEIKYUU_SOUFU_ADDRESS1;
                this.genbaEntity1.SEIKYUU_SOUFU_ADDRESS2 = this.GyoushaEntity.SEIKYUU_SOUFU_ADDRESS2;
                this.genbaEntity1.SEIKYUU_SOUFU_BUSHO = this.GyoushaEntity.SEIKYUU_SOUFU_BUSHO;
                this.genbaEntity1.SEIKYUU_SOUFU_TANTOU = this.GyoushaEntity.SEIKYUU_SOUFU_TANTOU;
                this.genbaEntity1.SEIKYUU_SOUFU_TEL = this.GyoushaEntity.SEIKYUU_SOUFU_TEL;
                this.genbaEntity1.SEIKYUU_SOUFU_FAX = this.GyoushaEntity.SEIKYUU_SOUFU_FAX;
                this.genbaEntity1.SEIKYUU_TANTOU = this.GyoushaEntity.SEIKYUU_TANTOU;
                this.genbaEntity1.SEIKYUU_DAIHYOU_PRINT_KBN = this.GyoushaEntity.SEIKYUU_DAIHYOU_PRINT_KBN;
                this.genbaEntity1.SEIKYUU_KYOTEN_PRINT_KBN = this.GyoushaEntity.SEIKYUU_KYOTEN_PRINT_KBN;
                this.genbaEntity1.SEIKYUU_KYOTEN_CD = this.GyoushaEntity.SEIKYUU_KYOTEN_CD;
                // 20160429 koukoukon v2.1_電子請求書 #16612 start
                //this.genbaEntity.HAKKOUSAKI_CD = this.GyoushaEntity.HAKKOUSAKI_CD;
                // 20160429 koukoukon v2.1_電子請求書 #16612 end
                this.genbaEntity1.SHIHARAI_SOUFU_NAME1 = this.GyoushaEntity.SHIHARAI_SOUFU_NAME1;
                this.genbaEntity1.SHIHARAI_SOUFU_NAME2 = this.GyoushaEntity.SHIHARAI_SOUFU_NAME2;
                this.genbaEntity1.SHIHARAI_SOUFU_KEISHOU1 = this.GyoushaEntity.SHIHARAI_SOUFU_KEISHOU1;
                this.genbaEntity1.SHIHARAI_SOUFU_KEISHOU2 = this.GyoushaEntity.SHIHARAI_SOUFU_KEISHOU2;
                this.genbaEntity1.SHIHARAI_SOUFU_POST = this.GyoushaEntity.SHIHARAI_SOUFU_POST;
                this.genbaEntity1.SHIHARAI_SOUFU_ADDRESS1 = this.GyoushaEntity.SHIHARAI_SOUFU_ADDRESS1;
                this.genbaEntity1.SHIHARAI_SOUFU_ADDRESS2 = this.GyoushaEntity.SHIHARAI_SOUFU_ADDRESS2;
                this.genbaEntity1.SHIHARAI_SOUFU_BUSHO = this.GyoushaEntity.SHIHARAI_SOUFU_BUSHO;
                this.genbaEntity1.SHIHARAI_SOUFU_TANTOU = this.GyoushaEntity.SHIHARAI_SOUFU_TANTOU;
                this.genbaEntity1.SHIHARAI_SOUFU_TEL = this.GyoushaEntity.SHIHARAI_SOUFU_TEL;
                this.genbaEntity1.SHIHARAI_SOUFU_FAX = this.GyoushaEntity.SHIHARAI_SOUFU_FAX;
                this.genbaEntity1.SHIHARAI_KYOTEN_PRINT_KBN = this.GyoushaEntity.SHIHARAI_KYOTEN_PRINT_KBN;
                this.genbaEntity1.SHIHARAI_KYOTEN_CD = this.GyoushaEntity.SHIHARAI_KYOTEN_CD;
                this.genbaEntity1.JISHA_KBN = this.GyoushaEntity.JISHA_KBN;
                this.genbaEntity1.SHOKUCHI_KBN = this.GyoushaEntity.SHOKUCHI_KBN;
                this.genbaEntity1.ITAKU_KEIYAKU_USE_KBN = 1;

                if (this.IsGenbaAdd)
                {
                    this.genbaEntity1.TSUMIKAEHOKAN_KBN = false;
                    this.genbaEntity1.SAISHUU_SHOBUNJOU_KBN = false;
                    this.genbaEntity1.MANI_HENSOUSAKI_KBN = this.GyoushaEntity.MANI_HENSOUSAKI_KBN;
                    this.genbaEntity1.MANIFEST_SHURUI_CD = this.sysinfoEntity.GENBA_MANIFEST_SHURUI_CD;
                    this.genbaEntity1.MANIFEST_TEHAI_CD = this.sysinfoEntity.GENBA_MANIFEST_TEHAI_CD;
                    this.genbaEntity1.DEN_MANI_SHOUKAI_KBN = false;
                    this.genbaEntity1.KENSHU_YOUHI = false;
                    // 20151020 BUNN #12040 STR
                    this.genbaEntity1.HAISHUTSU_NIZUMI_GENBA_KBN = this.GyoushaEntity.HAISHUTSU_NIZUMI_GYOUSHA_KBN;
                    this.genbaEntity1.SHOBUN_NIOROSHI_GENBA_KBN = this.GyoushaEntity.SHOBUN_NIOROSHI_GYOUSHA_KBN;
                    // 20151020 BUNN #12040 END
                }
                if (this.GyoushaEntity.MANI_HENSOUSAKI_KBN.IsTrue)
                {
                    if (this.GyoushaEntity.MANI_HENSOUSAKI_THIS_ADDRESS_KBN == 1)
                    {
                        this.genbaEntity1.MANI_HENSOUSAKI_THIS_ADDRESS_KBN = 1;
                        this.genbaEntity1.MANI_HENSOUSAKI_NAME1 = this.GyoushaEntity.GYOUSHA_NAME1;
                        this.genbaEntity1.MANI_HENSOUSAKI_NAME2 = this.GyoushaEntity.GYOUSHA_NAME2;
                        this.genbaEntity1.MANI_HENSOUSAKI_KEISHOU1 = this.GyoushaEntity.GYOUSHA_KEISHOU1;
                        this.genbaEntity1.MANI_HENSOUSAKI_KEISHOU2 = this.GyoushaEntity.GYOUSHA_KEISHOU2;
                        this.genbaEntity1.MANI_HENSOUSAKI_POST = this.GyoushaEntity.GYOUSHA_POST;
                        this.genbaEntity1.MANI_HENSOUSAKI_ADDRESS1 = this.GyoushaEntity.MANI_HENSOUSAKI_ADDRESS1;
                        this.genbaEntity1.MANI_HENSOUSAKI_ADDRESS2 = this.GyoushaEntity.GYOUSHA_ADDRESS2;
                        this.genbaEntity1.MANI_HENSOUSAKI_BUSHO = this.GyoushaEntity.BUSHO;
                        this.genbaEntity1.MANI_HENSOUSAKI_TANTOU = this.GyoushaEntity.TANTOUSHA;
                    }
                    else if (this.GyoushaEntity.MANI_HENSOUSAKI_THIS_ADDRESS_KBN == 2)
                    {
                        this.genbaEntity1.MANI_HENSOUSAKI_THIS_ADDRESS_KBN = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_NAME1 = this.GyoushaEntity.MANI_HENSOUSAKI_NAME1;
                        this.genbaEntity1.MANI_HENSOUSAKI_NAME2 = this.GyoushaEntity.MANI_HENSOUSAKI_NAME2;
                        this.genbaEntity1.MANI_HENSOUSAKI_KEISHOU1 = this.GyoushaEntity.MANI_HENSOUSAKI_KEISHOU1;
                        this.genbaEntity1.MANI_HENSOUSAKI_KEISHOU2 = this.GyoushaEntity.MANI_HENSOUSAKI_KEISHOU2;
                        this.genbaEntity1.MANI_HENSOUSAKI_POST = this.GyoushaEntity.MANI_HENSOUSAKI_POST;
                        this.genbaEntity1.MANI_HENSOUSAKI_ADDRESS1 = this.GyoushaEntity.MANI_HENSOUSAKI_ADDRESS1;
                        this.genbaEntity1.MANI_HENSOUSAKI_ADDRESS2 = this.GyoushaEntity.MANI_HENSOUSAKI_ADDRESS2;
                        this.genbaEntity1.MANI_HENSOUSAKI_BUSHO = this.GyoushaEntity.MANI_HENSOUSAKI_BUSHO;
                        this.genbaEntity1.MANI_HENSOUSAKI_TANTOU = this.GyoushaEntity.MANI_HENSOUSAKI_TANTOU;
                    }
                    else
                    {
                        this.genbaEntity1.MANI_HENSOUSAKI_NAME1 = string.Empty;
                        this.genbaEntity1.MANI_HENSOUSAKI_NAME2 = string.Empty;
                        this.genbaEntity1.MANI_HENSOUSAKI_KEISHOU1 = string.Empty;
                        this.genbaEntity1.MANI_HENSOUSAKI_KEISHOU2 = string.Empty;
                        this.genbaEntity1.MANI_HENSOUSAKI_POST = string.Empty;
                        this.genbaEntity1.MANI_HENSOUSAKI_ADDRESS1 = string.Empty;
                        this.genbaEntity1.MANI_HENSOUSAKI_ADDRESS2 = string.Empty;
                        this.genbaEntity1.MANI_HENSOUSAKI_BUSHO = string.Empty;
                        this.genbaEntity1.MANI_HENSOUSAKI_TANTOU = string.Empty;
                    }
                    ...
                    if (this.IsGenbaAdd)
                    {
                        if (1 == this.sysinfoEntity.MANIFEST_USE_A)
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_A = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_A = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_A = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_A = this.genbaEntity1.GYOUSHA_CD;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_A = this.genbaEntity1.GENBA_CD;
                        }
                        else
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_A = 2;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_A = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_A = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_A = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_A = null;
                        }

                        if (1 == this.sysinfoEntity.MANIFEST_USE_B1)
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_B1 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_B1 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_B1 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_B1 = this.genbaEntity1.GYOUSHA_CD;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_B1 = this.genbaEntity1.GENBA_CD;
                        }
                        else
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_B1 = 2;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_B1 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_B1 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_B1 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_B1 = null;
                        }

                        if (1 == this.sysinfoEntity.MANIFEST_USE_B2)
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_B2 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_B2 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_B2 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_B2 = this.genbaEntity1.GYOUSHA_CD;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_B2 = this.genbaEntity1.GENBA_CD;
                        }
                        else
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_B2 = 2;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_B2 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_B2 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_B2 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_B2 = null;
                        }

                        if (1 == this.sysinfoEntity.MANIFEST_USE_B4)
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_B4 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_B4 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_B4 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_B4 = this.genbaEntity1.GYOUSHA_CD;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_B4 = this.genbaEntity1.GENBA_CD;
                        }
                        else
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_B4 = 2;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_B4 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_B4 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_B4 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_B4 = null;
                        }

                        if (1 == this.sysinfoEntity.MANIFEST_USE_B6)
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_B6 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_B6 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_B6 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_B6 = this.genbaEntity1.GYOUSHA_CD;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_B6 = this.genbaEntity1.GENBA_CD;
                        }
                        else
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_B6 = 2;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_B6 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_B6 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_B6 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_B6 = null;
                        }

                        if (1 == this.sysinfoEntity.MANIFEST_USE_C1)
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_C1 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_C1 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_C1 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_C1 = this.genbaEntity1.GYOUSHA_CD;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_C1 = this.genbaEntity1.GENBA_CD;
                        }
                        else
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_C1 = 2;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_C1 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_C1 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_C1 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_C1 = null;
                        }

                        if (1 == this.sysinfoEntity.MANIFEST_USE_C2)
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_C2 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_C2 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_C2 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_C2 = this.genbaEntity1.GYOUSHA_CD;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_C2 = this.genbaEntity1.GENBA_CD;
                        }
                        else
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_C2 = 2;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_C2 = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_C2 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_C2 = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_C2 = null;
                        }

                        if (1 == this.sysinfoEntity.MANIFEST_USE_D)
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_D = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_D = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_D = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_D = this.genbaEntity1.GYOUSHA_CD;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_D = this.genbaEntity1.GENBA_CD;
                        }
                        else
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_D = 2;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_D = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_D = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_D = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_D = null;
                        }

                        if (1 == this.sysinfoEntity.MANIFEST_USE_E)
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_E = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_E = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_E = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_E = this.genbaEntity1.GYOUSHA_CD;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_E = this.genbaEntity1.GENBA_CD;
                        }
                        else
                        {
                            this.genbaEntity1.MANI_HENSOUSAKI_USE_E = 2;
                            this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_E = 1;
                            this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_E = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_E = null;
                            this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_E = null;
                        }
                    }
                }
                else
                {
                    ...
                    this.genbaEntity1.MANI_HENSOUSAKI_KEISHOU2 = this.GyoushaEntity.GYOUSHA_KEISHOU2;
                    this.genbaEntity1.MANI_HENSOUSAKI_POST = this.GyoushaEntity.GYOUSHA_POST;
                    this.genbaEntity1.MANI_HENSOUSAKI_ADDRESS1 = this.GyoushaEntity.GYOUSHA_ADDRESS1;
                    this.genbaEntity1.MANI_HENSOUSAKI_ADDRESS2 = this.GyoushaEntity.GYOUSHA_ADDRESS2;
                    this.genbaEntity1.MANI_HENSOUSAKI_BUSHO = this.GyoushaEntity.BUSHO;
                    this.genbaEntity1.MANI_HENSOUSAKI_TANTOU = this.GyoushaEntity.TANTOUSHA;
                    ...
                    {
                        this.genbaEntity1.MANI_HENSOUSAKI_USE_A = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_A = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_A = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_A = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_A = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_USE_B1 = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_B1 = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_B1 = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_B1 = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_B1 = null;

                        this.genbaEntity1.MANI_HENSOUSAKI_USE_B2 = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_B2 = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_B2 = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_B2 = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_B2 = null;

                        this.genbaEntity1.MANI_HENSOUSAKI_USE_B4 = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_B4 = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_B4 = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_B4 = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_B4 = null;

                        this.genbaEntity1.MANI_HENSOUSAKI_USE_B6 = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_B6 = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_B6 = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_B6 = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_B6 = null;

                        this.genbaEntity1.MANI_HENSOUSAKI_USE_C1 = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_C1 = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_C1 = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_C1 = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_C1 = null;

                        this.genbaEntity1.MANI_HENSOUSAKI_USE_C2 = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_C2 = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_C2 = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_C2 = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_C2 = null;

                        this.genbaEntity1.MANI_HENSOUSAKI_USE_D = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_D = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_D = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_D = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_D = null;

                        this.genbaEntity1.MANI_HENSOUSAKI_USE_E = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_PLACE_KBN_E = 2;
                        this.genbaEntity1.MANI_HENSOUSAKI_TORIHIKISAKI_CD_E = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GYOUSHA_CD_E = null;
                        this.genbaEntity1.MANI_HENSOUSAKI_GENBA_CD_E = null;
                    }
                }
                this.genbaEntity1.TEKIYOU_BEGIN = this.GyoushaEntity.TEKIYOU_BEGIN;
                this.genbaEntity1.TEKIYOU_END = this.GyoushaEntity.TEKIYOU_END;
                this.genbaEntity1.UPN_HOUKOKUSHO_TEISHUTSU_CHIIKI_CD = this.GyoushaEntity.UPN_HOUKOKUSHO_TEISHUTSU_CHIIKI_CD;

                // mapbox情報
                this.genbaEntity1.GENBA_LATITUDE = this.GyoushaEntity.GYOUSHA_LATITUDE;
                this.genbaEntity1.GENBA_LONGITUDE = this.GyoushaEntity.GYOUSHA_LONGITUDE;
                if (string.IsNullOrEmpty(this.form.GyoushaLatitude.Text) &&
                    string.IsNullOrEmpty(this.form.GyoushaLongitude.Text) &&
                    string.IsNullOrEmpty(this.form.LocationInfoUpdateName.Text) &&
                    string.IsNullOrEmpty(this.form.LocationInfoUpdateDate.Text))
                ...
                {
                    this.genbaEntity1.GENBA_LOCATION_INFO_UPDATE_NAME = SystemProperty.UserName;
                    this.genbaEntity1.GENBA_LOCATION_INFO_UPDATE_DATE = this.sysDate();
                }

                var dataBinderLogic = new DataBinderLogic<M_GENBA>(this.genbaEntity1);
                dataBinderLogic.SetSystemProperty(this.genbaEntity1, false);
                MasterCommonLogic.SetFooterProperty(MasterCommonLogic.GetCurrentShain(this.form), this.genbaEntity1);
            ...
            {
                LogUtility.Error("CreateGenbaEntity1", ex);
                this.form.errmessage.MessageBoxShow("E245", "");
                LogUtility.DebugMethodEnd(true);
                return true;
            }
        ...
        public virtual void Regist(bool errorFlag)
        {
            try
            {
                ...
                //quoc
                if (null != this.genbaEntity1)
                {
                    this.daoGenba.Insert(this.genbaEntity1);
                }
                //quoc
