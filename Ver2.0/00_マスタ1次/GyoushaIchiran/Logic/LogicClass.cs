...
namespace GyoushaIchiran.Logic
{
    ...
    internal class LogicClass : IBuisinessLogic
    {
        ...
        //quocbegin
        //private IM_URIAGEDao daoUriage;
        //quocend
        ...
        public LogicClass(GyoushaIchiranForm targetForm)
        {
            ...
            //quoc-begin
            //this.daoUriage = DaoInitUtility.GetComponent<IM_URIAGEDao>();
            //quoc-end
        ...
        private void bt_func7_Click(object sender, EventArgs e)
        {
            ...
            //quoc-begin
            this.form.GYOUSHA_URIAGE_CD.Clear();
            this.form.GYOUSHA_URIAGE_NAME.Clear();
            this.form.GYOUSHA_SHIHARAI_CD.Clear();
            this.form.GYOUSHA_SHIHARAI_NAME.Clear();
            //quoc-end
        ...
        #region ヘッダーの初期化(Khởi tạo tiêu đề)
        ...
        private void InitHeaderArea()
        {
            ...
            //quoc-begin
            //if (!string.IsNullOrEmpty(this.form.GYOUSHA_URIAGE_NAME.Text))
            //{
            //    this.uriageEntity = daoUriage.GetDataByCd(this.form.GYOUSHA_URIAGE_NAME.Text);
            //    this.form.GYOUSHA_URIAGE_NAME.Text = this.uriageEntity == null ? string.Empty : uriageEntity.GURUUPU_MEI;
            //}
            //if (!string.IsNullOrEmpty(this.form.GYOUSHA_URIAGE_CD.Text))
            //{
            //    this.uriageEntity = daoUriage.GetDataByCd(this.form.GYOUSHA_URIAGE_CD.Text);
            //    this.form.GYOUSHA_URIAGE_CD.Text = this.uriageEntity == null ? string.Empty : uriageEntity.GURUUPU_MEI;
            //}
            //quoc-end
        ...
        private string CreateSelectQuery()
        {
            ...
            if (!string.IsNullOrWhiteSpace(this.form.SelectQuery))
            {
                ...
                sb.AppendFormat(" M_GYOUSHA.MOD_GURUUPU_CD AS {0}, ", GyoushaIchiranConstans.HIDDEN_URIAGE_NAME);
        ...
        private string CreateFromQuery()
        {
            ...
            //quoc-begin
           // sb.Append(" LEFT JOIN M_URIAGE ");
            //sb.Append(" ON M_GYOUSHA.MOD_GURUUPU_CD = M_URIAGE.GURUUPU_CD ");
            //quoc-end
        ...
        private string CreateWhereQuery()
        {
            ...
            //quoc
            // 
            strTemp = this.form.GYOUSHA_URIAGE_CD.Text;
            if (!string.IsNullOrWhiteSpace(strTemp))
            {
                if (!string.IsNullOrWhiteSpace(result.ToString()))
                {
        ...
        ///<summary>
        ///業者CDの削除済みチェック
        ///Kiểm tra xóa đối với đĩa CD của người bán
        ///</summary>
        ...
        //        bool ret = true;
        //        this.form.GYOUSHA_URIAGE_NAME.Text = string.Empty;
        //        if (!string.IsNullOrEmpty(this.form.GYOUSHA_URIAGE_CD.Text))
        //        {
        //            M_URIAGE search = new M_URIAGE();
        //            search.GURUUPU_CD = this.form.GYOUSHA_URIAGE_CD.Text;
        //            M_URIAGE[] uriage = this.daoUriage.GetAllValidData(search);
        //            if (uriage != null && busho.Length > 0 && !busho[0].BUSHO_CD.Equals("999"))
        //            {
