...
namespace GyoushaIchiran.APP
{
    public partial class GyoushaIchiranForm : IchiranSuperForm
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            // 初回のみ(Lần đầu tiên duy nhất)
            if (this.businessLogic == null)
            {
                // ビジネスロジックの初期化(Khởi tạo logic nghiệp vụ)
                ...
                //quoc-begin
                this.pnl_uriage.Location = new System.Drawing.Point(this.customSortHeader1.Location.X, this.customSortHeader1.Location.Y + 25);
                //quoc-end
                this.customDataGridView1.Location = new System.Drawing.Point(3, 234);
                this.customDataGridView1.Size = new System.Drawing.Size(997, 220);
            ...
            if (this.customDataGridView1.DataSource != null && this.Table != null)
            {
                foreach (DataGridViewColumn col in this.customDataGridView1.Columns)
                {
                    if (col.Name == GyoushaIchiranConstans.KEY_ID1 ||
                        ...
                        //quoc
                        col.Name == GyoushaIchiranConstans.HIDDEN_URIAGE_NAME
                        )
                    {
                        col.Visible = false;
                    }
