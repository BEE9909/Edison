...
namespace GenbaHoshu.Logic
{
    ...
    public class GenbaHoshuLogic : IBuisinessLogic
    {
        ...
        private void AllControlLock(bool isBool)
        {
            ...
            //quoc-begin
            this.form.MOD_CHIZU.Enabled = isBool;
            this.form.MOD_ETSURAN.Enabled = isBool;
            this.form.MOD_SANSHOU.Enabled = isBool;
            //quoc-end
        ...
        public bool CreateEntity(bool isDelete)
        {
            try
            {
                ...
                this.GenbaEntity.MOD_CHIZU = this.form.MOD_CHIZU.Text;
