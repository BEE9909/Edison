...
namespace GenbaHoshu.APP
{
    ...
    public partial class GenbaHoshuForm : SuperForm
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //※※※　強引な対応ここまで
            //quoc-begin
            this.MOD_ETSURAN.Location = new System.Drawing.Point(this.MOD_SANSHOU.Location.X +60, this.MOD_SANSHOU.Location.Y);
            //quoc-end
        ...
        private void MOD_SANSHOU_Click(object sender, EventArgs e)
        {
            ...
            if(dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    this.MOD_CHIZU.Text = dialog.FileName;
                }
            }
        }

        private void MOD_ETSURAN_Click(object sender, EventArgs e)
        {
            Process.Start(this.MOD_CHIZU.Text);
        }
    }
}