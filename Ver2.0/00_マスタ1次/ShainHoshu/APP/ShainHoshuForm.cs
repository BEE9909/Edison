...
namespace ShainHoshu.APP
{
    ...
    public partial class ShainHoshuForm : SuperForm
    {
            ...
            : base(WINDOW_ID.M_SHAIN, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            ...
            //Đã sửa chữa hoàn toàn. Không thực hiện thay đổi ở đây
        ...
        private void Ichiran_CellValidating(object sender, CellValidatingEventArgs e)
        {
            ...
            //quoc-begin
            if (e.CellName.Equals(Const.ShainHoshuConstans.MOD_INEI_DATA))
            {
                
                if (!this.logic.CheckPNGorBMP(e.RowIndex))
                {
                    this.errmessage.MessageBoxShowError("BMPファイル　または　PNGファイルを選択してください。");
                    e.Cancel = true;
                }
            }
            //quoc-end
        ...
        private void Ichiran_CellContentButtonClick(object sender, CellEventArgs e)
        {
            ...
            if (e.CellName.Equals(Const.ShainHoshuConstans.MOD_BTN_SANSHO))
            {
                this.logic.FileRefClick(e.RowIndex);
            }
            if (e.CellName.Equals(Const.ShainHoshuConstans.MOD_BTN_ETSURAN))
            {
                this.logic.BrowseClick(e.RowIndex);
            }
