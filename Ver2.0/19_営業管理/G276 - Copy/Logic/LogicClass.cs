    ...
    internal class LogicClass : IBuisinessLogic
    {
        ...
        private void WindowsSetEntrtyData()
        {
            ...
            try
            {
                ...
                //this.form.txt_Bikou1.Text = popupInit.logic.value1;
                //if (this.popupInit.logic.value1 != null && !string.IsNullOrEmpty(this.popupInit.logic.value1.ToString()))
                //{
                //    this.form.txt_Bikou5.Text = this.popupInit.logic.value1.;
                //}
                //quoc-end
