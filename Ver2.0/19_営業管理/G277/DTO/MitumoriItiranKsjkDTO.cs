...
namespace Shougun.Core.BusinessManagement.MitumoriIchiran
{
    public class MitumoriItiranKsjkDTO
    {
        ...
        //public String MOD_SHOUNIN { get; set; }

        public String MOD_SHOUNIN_STATUS { get; set; }
        public String MOD_SHOUNIN_NICHIJI_FROM { get; set; }
        public String MOD_SHOUNIN_NICHIJI_TO { get; set; }
        //quoc-end
    }
}
