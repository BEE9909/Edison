...
namespace Shougun.Core.BusinessManagement.MitumoriIchiran
{
    ...
    public partial class MitumoriIchiranForm : Shougun.Core.Common.IchiranCommon.APP.IchiranSuperForm
    {
        ...
        //quoc-begin
        internal static readonly string MOD1 = "承認";
        //quoc-end
            ...
            : base(denshuKbn, false)
        {
            try
            {
                ...
                this.DenshuKbn = DENSHU_KBN.MITSUMORI; // 伝種区分を取得 Nhận phân loại giống
        ...
        protected override void OnLoad(EventArgs e)
        {
            try
            {
                ...
                // 画面情報の初期化
                //Khởi tạo thông tin màn hình
                if (isLoaded == false)
                {
                    this.MitumoriIchiranLogic.WindowInit();

                    this.customSearchHeader1.Visible = true;
                    this.customSearchHeader1.Location = new System.Drawing.Point(4, 131);
                    this.customSearchHeader1.Size = new System.Drawing.Size(997, 26);

                    this.customSortHeader1.Location = new System.Drawing.Point(4, 153);
                    this.customSortHeader1.Size = new System.Drawing.Size(997, 26);

                    this.customDataGridView1.Location = new System.Drawing.Point(3, 180);
                    this.customDataGridView1.Size = new System.Drawing.Size(997, 200);
                    //quoc-begin
                    this.customPanel2.Location = new System.Drawing.Point(126, 28);
                    this.customPanel2.Size = new System.Drawing.Size(221, 45);

                    this.customPanel3.Location = new System.Drawing.Point(this.customPanel1.Location.X, this.customPanel1.Location.Y + 73);
        ...
        public virtual void ShowData()
        {
            try
            {
                if (!this.DesignMode)
                {
                    ...
                    this.logic.CreateDataGridView(this.Table);
                    //quoc-begin
                    DataGridViewCell datagridviewcell = this.customDataGridView1.CurrentCell;
                    DataTable dtSource = customDataGridView1.DataSource as DataTable;
                    if (datagridviewcell != null)
                    {
                        if (this.MOD_SHOUNIN_STATUS.Text == "1" || this.MOD_SHOUNIN_STATUS.Text == "3")
                        {
                            if (this.customDataGridView1.DataSource != null)
                            {

                                //this.customDataGridView1.Rows[datagridviewcell.RowIndex].Cells[this.MitumoriIchiranLogic.MOD_CELL_SHOUNIN_STATUS].ReadOnly = false;
                                if (this.customDataGridView1.Columns.Contains(this.MitumoriIchiranLogic.MOD_CELL_SHOUNIN))
                                {
                                    dtSource.Columns[this.MitumoriIchiranLogic.MOD_CELL_SHOUNIN].ReadOnly = false;
                                    this.customDataGridView1.Rows[datagridviewcell.RowIndex].Cells[this.MitumoriIchiranLogic.MOD_CELL_SHOUNIN].Value = true;
                                    dtSource.Columns[this.MitumoriIchiranLogic.MOD_CELL_SHOUNIN_STATUS].ReadOnly = true;
                    ...
                    //    if (this.customDataGridView1.Columns.Contains(this.MitumoriIchiranLogic.MOD_CELL_SHOUNIN))
                    //    {
                    //        this.customDataGridView1.Rows[dgvRow.Index].Cells[this.MitumoriIchiranLogic.MOD_CELL_SHOUNIN].ReadOnly = false;
                    //    }
                    //    if (datagridviewcell != null)
                    //    {
                    ...
                    //        if (this.MOD_SHOUNIN_STATUS.Text == "1" || this.MOD_SHOUNIN_STATUS.Text == "3")
                    //        {
                    //            this.customDataGridView1.Rows[datagridviewcell.RowIndex].Cells[this.MitumoriIchiranLogic.MOD_CELL_SHOUNIN].Value = 1;
                    //        }
                    //    }
                    //}
                    //quoc-begin
                    ...
                    //DataGridViewRow datagridviewrow = this.customDataGridView1.CurrentRow;
                    //// Lấy về giá trị của cột "A"
                    //string columnText = datagridviewrow.Cells["承認"].;
                    //datagridviewrow.Cells["承認"].Value = true;
                    //foreach (DataGridViewRow dgvRow in this.customDataGridView1.Rows)
                    //{
                    ...
                    //     this.customDataGridView1.Rows[dgvRow.Index].Cells["承認"].Value = true;


                    //}
                    //DataGridViewRow selectedRow = this.customDataGridView1.CurrentRow;
                    //if (selectedRow != null)
                    //{
                    //    selectedRow.Cells["承認"].ReadOnly = false;
                    //   var c1 =  selectedRow.Cells["承認"].Value;
                    //}
        ...
        private void MOD_SHOUNIN_STATUS_TextChanged(object sender, EventArgs e)
        {
            if (this.MOD_SHOUNIN_STATUS.Text == "0")
            {
                this.MOD_SHINSEI_NAKA.Enabled = true;
            }
            ...
            if (datagridviewcell != null)
            {
                ...
                else
                {
                    if (this.customDataGridView1.DataSource != null)
                    {
                        ...
                        {
                            dtSource.Columns[this.MitumoriIchiranLogic.MOD_CELL_SHOUNIN].ReadOnly = false;
                            this.customDataGridView1.Rows[datagridviewcell.RowIndex].Cells[this.MitumoriIchiranLogic.MOD_CELL_SHOUNIN].Value = false;
                            dtSource.Columns[this.MitumoriIchiranLogic.MOD_CELL_SHOUNIN_STATUS].ReadOnly = true;
