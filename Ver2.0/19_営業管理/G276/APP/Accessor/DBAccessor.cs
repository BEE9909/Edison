...
namespace Shougun.Core.BusinessManagement.MitsumoriNyuryoku.Accessor
{
    ...
    public class DBAccessor
    {
        ...
        //quoc-begin
        r_framework.Dao.IM_TODOUFUKENDao todouDao;
        //quoc-end
        ...
        public DBAccessor()
        {
            ...
            //quoc-begin
            this.todouDao = DaoInitUtility.GetComponent<r_framework.Dao.IM_TODOUFUKENDao>();
            //quoc-end
        ...
        //quoc-begin
        public M_TODOUFUKEN[] GetDataByCodeForToDouFuKen(string todoufuken)
        {
            if (string.IsNullOrEmpty(todoufuken))
            {
                return null;
            }

            M_TODOUFUKEN keyEntity = new M_TODOUFUKEN();
            keyEntity.TODOUFUKEN_CD = Int16.Parse(todoufuken);
            return this.todouDao.GetAllValidData(keyEntity);
        }
        //quoc-end
        /// <summary>
        /// 消費税率を取得
