...
namespace Shougun.Core.BusinessManagement.MitsumoriNyuryoku
{
    internal class DTOClass
    {
        ...
        //quoc-begin
        //M_SHAIN
        internal M_SHAIN shainEnity;

        //M_TODOUFUKEN
        internal M_TODOUFUKEN todoufukenEnity;
        //quoc-end
        ...
        /// M_URIAGE
        /// </summary>
        internal M_URIAGE uriageEntity;
        ...
        public DTOClass()
        {
            ...
            //quoc-begin
            this.uriageEntity = new M_URIAGE();
        }
        ...
        private T_MITSUMORI_ENTRY MitsumoriEntityClone()
        {
            ...
            //quoc-begin
            returnEntity.MOD_URIAGE_GURUUPU_CD = this.entryEntity.MOD_URIAGE_GURUUPU_CD;
            returnEntity.MOD_URIAGE_GURUUPU_NAME = this.entryEntity.MOD_URIAGE_GURUUPU_NAME;
            returnEntity.MOD_SHIHARAI_GURUUPU_CD = this.entryEntity.MOD_SHIHARAI_GURUUPU_CD;
            returnEntity.MOD_SHIHARAI_GURUUPU_NAME = this.entryEntity.MOD_SHIHARAI_GURUUPU_NAME;
            returnEntity.MOD_KAKUIN_INJI = this.entryEntity.MOD_KAKUIN_INJI;
            returnEntity.MOD_GOUKEI_KINGAKU_INJI = this.entryEntity.MOD_GOUKEI_KINGAKU_INJI;
            //quoc-end
