...
namespace Shougun.Core.BusinessManagement.Soushinpyoubikou.DAO
{
    ...
    public interface IM_HIKIAI_TORIHIKISAKIDao : IS2Dao
    {
        ...
        /// <parameparam name="data">Entity</parameparam>
        /// <returns>取得したデータのリスト</returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.DAO.SqlFile.HikiaiTorihikisaki.IM_HIKIAI_TORIHIKISAKIDao_GetAllValidData.sql")]
        ...
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.DAO.SqlFile.Nyuukinsaki.IM_NYUUKINSAKIDao_GetMinBlankNo.sql")]
        ...
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetUselessTorihikisakiCode.sql")]
        ...
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.DAO.SqlFile.HikiaiTorihikisaki.IM_HIKIAI_TORIHIKISAKIDao_GetTorihikisakiData.sql")]
