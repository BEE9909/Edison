...
namespace Shougun.Core.BusinessManagement.Soushinpyoubikou.DAO
{
    ...
    public interface IM_HIKIAI_GYOUSHADao : IS2Dao
    {
        ...
        /// <parameparam name="data">Entity</parameparam>
        /// <returns>取得したデータのリスト</returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.DAO.SqlFile.HikiaiGyousha.IM_HIKIAI_GYOUSHADao_GetAllValidData.sql")]
        ...
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetUselessGyoushaCode.sql")]
