...
namespace Shougun.Core.BusinessManagement.Soushinpyoubikou.DAO
{
    /// <summary>
    /// 現場マスタDao
    /// </summary>
    ...
    public interface IM_HIKIAI_GENBADao : IS2Dao
    {
        ...
        /// <parameparam name="data">Entity</parameparam>
        /// <returns>取得したデータのリスト</returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.DAO.SqlFile.HikiaiGenba.IM_HIKIAI_GENBADao_GetAllValidData.sql")]
        ...
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.DAO.SqlFile.HikiaiGenba.IM_HIKIAI_GENBADao_GetKokyakuCustomDataGridViewData.sql")]
        ...
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.DAO.SqlFile.HikiaiGenba.IM_HIKIAI_GENBADao_GetUserSettingData.sql")]
        ...
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.DAO.SqlFile.HikiaiGenba.IM_HIKIAI_GENBADao_GetKokyakuMasterData.sql")]
        ...
        /// <parameparam name="data">Entity</parameparam>
        /// <returns>取得したデータのリスト</returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.DAO.SqlFile.HikiaiGenba.IM_HIKIAI_GENBADao_GetAllValidDataForPopUp.sql")]
        ...
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetUselessGenbaCode.sql")]
