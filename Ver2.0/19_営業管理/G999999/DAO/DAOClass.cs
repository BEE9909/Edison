...
namespace Shougun.Core.BusinessManagement.Soushinpyoubikou
{
    ...
    public interface MitsumoriTantousyaDao : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetShainData.sql")]
    ...
    public interface MitsumoriKyotenDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetKyotenData.sql")]
    ...
    public interface MitsumoriTorihikisakiDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetTorihikisakiData.sql")]
    ...
    public interface MitsumoriGyoushaDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetGyoushaData.sql")]
    ...
    public interface MitsumoriGenbaDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetGenbaData.sql")]
    ...
    public interface MitsumoriToriikisakiSeikyuDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetSeikyuuData.sql")]
    ...
    public interface MitsumoriToriikisakiShiharaiDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetShiharaiData.sql")]
    ...
    public interface MitsumoriShouhizeiDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetShouhizeiData.sql")]
    ...
    public interface HikiaiTorihikisakiDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.CheckHikiaiTorihikisakiData.sql")]
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetHikiaiTorihikisakiData.sql.sql")]
        ...
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetMaxTorihikisakiCode.sql")]
    ...
    public interface HikiaiGyoushaDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.CheckGyoushaData.sql")]
        ...
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetMaxGyoushaCode.sql")]
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetHikiaiGyoushaData.sql")]
    ...
    public interface HikiaiGenbaDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.CheckHikiaiGenbaData.sql")]
        ...
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetMaxGenbaCode.sql")]
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetHikiaiGenbaData.sql")]
    ...
    public interface MitsumoriEntryDao : IS2Dao
    {
        ...
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetMitsumoriEntryData.sql")]
    ...
    public interface MitsumoriDetailEntryDao : IS2Dao
    {
        ...
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.Soushinpyoubikou.Sql.GetMitsumoriDetailEntryData.sql")]
