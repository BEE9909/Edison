...
using Shougun.Core.BusinessManagement.Soushinpyoubikou.Accessor;
using Shougun.Core.BusinessManagement.Soushinpyoubikou;
using Shougun.Core.BusinessManagement.Soushinpyoubikou.DTO;
...
namespace Shougun.Core.BusinessManagement.Soushinpyoubikou
{
    ...
    internal class LogicClass : IBuisinessLogic
    {
        ...
        /// ボタン設定格納ファイル
        /// </summary>
        private readonly string ButtonInfoXmlPath = "Shougun.Core.BusinessManagement.Soushinpyoubikou.Setting.ButtonSetting.xml";
        ...
        /// Form
        /// </summary>
        private SoushinpyoubikouForm form;
        ...
        /// DBアクセッサー
        /// </summary>
        internal Shougun.Core.BusinessManagement.Soushinpyoubikou.Accessor.DBAccessor accessor;
        ...
        /// コンストラクタ
        /// </summary>
        public LogicClass(SoushinpyoubikouForm targetForm)
        {
            ...
            // Accessor
            this.accessor = new Shougun.Core.BusinessManagement.Soushinpyoubikou.Accessor.DBAccessor();
        ...
        public bool WindowInit()
        {
            ...
            try
            {
                ...
                // 201400704 syunrei EV002427_送信票備考の税計算区分がシステム設定の税区分締処理利用形態を参照していない　start
                //システム設定入力の税区分/締処理利用形態の登録内容に応じて、送信票備考の税計算区分で選択されていない方を非活性にする。
                // 201400708 syunrei EV002428_内税の計算を修正する。　start
                ...
                // 201400704 syunrei EV002427_送信票備考の税計算区分がシステム設定の税区分締処理利用形態を参照していない　end

                // 201400708 syunrei ＃947　№11　　start
                if (!this.SetMeisaiZeiKbnCtr(false)) { throw new Exception(""); }
                //・送信票備考画面内、状況項目内、進行中項目は削除する。
                this.DeleteJoukyo();
                ...
                if (headerReportItemName[iHeader].Equals("EIGYO_TANTOUSHA_NAME"))
               {
                ...
                if (headerReportItemName[iHeader].Equals("MITSUMORI_DATE"))
                {
                    ...
                    if ("True".Equals(valueInji.ToString()))
                    {
                        ...
                        //quoc-begin
                        if(this.form.txt_MitsumoriInjiDate.Text == "1")
                        {
        ...
        private bool CreateHikiaiTorihikisakiEntity()
        {
            ...
            // 20140717 katen No.5299 送信票備考から引合取引先登録後、引合取引先を修正モードで開くと見積印字設定の代表者を印字区分がブランクになってしまっている start‏
            IM_SYS_INFODao daoIM_SYS_INFO = DaoInitUtility.GetComponent<IM_SYS_INFODao>();
            M_SYS_INFO[] sysInfo = daoIM_SYS_INFO.GetAllData();
            ...
            // 20140717 katen No.5299 送信票備考から引合取引先登録後、引合取引先を修正モードで開くと見積印字設定の代表者を印字区分がブランクになってしまっている end‏
        ...
        {
            //システム設定入力の税区分情報取得
            M_SYS_INFO mSysInfo = new Shougun.Core.BusinessManagement.Soushinpyoubikou.Accessor.DBAccessor().GetSysInfo();
