            ...
            switch (this.form.WindowId)
            {
                ...
                case WINDOW_ID.M_GENBA_ALL:
                    ...
                    this.hideColumnNames = new string[] { "GENBA_NAME1", "GENBA_NAME2", "GENBA_ADDRESS2", "GYOUSHA_NAME1", "GYOUSHA_NAME2", "GYOUSHA_ADDRESS1", "GYOUSHA_ADDRESS2",
                        "TORIHIKISAKI_CD", "TORIHIKISAKI_NAME_RYAKU", "TORIHIKISAKI_NAME1", "TORIHIKISAKI_NAME2", "TORIHIKISAKI_ADDRESS1", "TORIHIKISAKI_ADDRESS2" ,
                ...
                case WINDOW_ID.M_HINMEI_SEARCH:
                    ...
                    if (this.form.WindowId.Equals(WINDOW_ID.M_HINMEI_SEARCH))
                    {
                        ...
                        this.displayColumnNames = new string[] { "伝票", "種類CD", "種類名", "種類名ﾌﾘｶﾞﾅ", "品名CD", "品名", "品名ﾌﾘｶﾞﾅ", "単位", "単価"};
                        // 画面レイアウト変更
                        this.ChangeLayout();
                    ...
                    else
                    {
                        ...
                        this.displayColumnNames = new string[] { "種類CD", "種類名", "種類名ﾌﾘｶﾞﾅ", "品名CD", "品名", "品名ﾌﾘｶﾞﾅ" };
