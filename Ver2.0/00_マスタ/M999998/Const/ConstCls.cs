...
using System.Data;
using System;
namespace Shougun.Core.Master.UriageHoshu.Const
{
    /// <summary>
    /// 定数クラス
    /// </summary>
    ...
    {
        /// <summary>M_CONTENA_SHURUIのGURUUPU_CD</summary>
        public static readonly string GURUUPU_CD = "GURUUPU_CD";
        /// <summary>M_CONTENA_SHURUIのDENPYOU_KBN_CD</summary>
        ...
        //internal const string DEF_COLNAME_GURUUPU_CD = "GURUUPU_CD";
        ...
        //    tbl.Columns.Add(DEF_COLNAME_GURUUPU_CD, typeof(string));
        ...
        //        addRow[DEF_COLNAME_GURUUPU_CD] = row[DEF_COLNAME_GURUUPU_CD];
