...
namespace Shougun.Core.Common.IchiranCommon.Logic
{
    ...
    public class IchiranBaseLogic
    {
        ...
        public void CreateDataGridView(DataTable table)
        {
            ...
            //Nếu có một hộp kiểm tiêu đề, hãy thêm nó vào nguồn dữ liệu
            ...
            //Vẽ và hiển thị trạng thái trong đó tất cả các hàng được xóa với tiêu đề bên trái
            ...
            //Nếu bạn không khởi tạo nó bằng null một lần ở đây, thứ tự cột sẽ sai (có vấn đề với việc tạo cột DGV tự động?)
            this.form.customDataGridView1.DataSource = null;
            this.form.customDataGridView1.DataSource = table;

            //ヘッダチェックボックスがある場合、
            // Nếu bạn có một hộp kiểm tiêu đề
