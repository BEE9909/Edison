...
namespace r_framework.FormManager
{
    ...
    public class FormManager
    {
        ...
        /// Dọn dẹp các biểu mẫu không hoạt động khỏi bản đồ biểu mẫu
        /// </summary>
        ...
        private bool openForm(string formID, params object[] args)
        {
            ...
            // メニューから呼ばれたどうか調べる
            //kiểm tra xem nó có được gọi từ menu không
            ...
            //Kiểm tra xem có màn hình nào hiển thị cùng số màn hình và cùng nội dung không
            foreach (var info in this.openedFormInfoList)
            {
