...
namespace r_framework.Const
{
    ...
    {
        NONE = 0,
        /// <summary>新規(Mới)</summary>
        NEW_WINDOW_FLAG = 1,
        /// <summary>参照(thẩm quyền giải quyết)</summary>
        REFERENCE_WINDOW_FLAG = 2,
        /// <summary>削除(xóa bỏ)</summary>
        DELETE_WINDOW_FLAG = 3,
        /// <summary>修正(sửa chữa)</summary>
        UPDATE_WINDOW_FLAG = 4,
        /// <summary>一覧(danh sách)</summary>
