        ...
        private void DisplyInit()
        {
            ...
            switch (this.form.WindowId)
            {
                ...
                case WINDOW_ID.M_GYOUSHA_ALL:
                    ...
                    this.returnParamNames = popupGetMasterField;
                    this.displayColumnNames = new string[] { "取引先CD", "取引先名", "業者CD", "業者名", "フリガナ", "郵便番号", "都道府県", "住所", "電話番号", "非表示１", "非表示２", "非表示３", "非表示４", "非表示５", "非表示６", "非表示７" };
                ...
                case WINDOW_ID.M_HIKIAI_TORIHIKISAKI_NYUURYOKU:
                    ...
                    this.returnParamNames = popupGetMasterField;
                    this.displayColumnNames = new string[] { "取引先CD", "取引先名", "フリガナ", "郵便番号", "都道府県", "住所", "電話番号", "非表示１" };
